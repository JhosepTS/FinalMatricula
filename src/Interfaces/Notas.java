                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtCurso, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
 ...
 private void cargarDatosDesdeArchivo() {
   ...
   try (PrintWriter writer = new PrintWriter(new FileWriter(rutaArchivo, true))) {
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        try{
        Notass x=new Notass();
         x.setApellidosNombres(txtApellidos.getText());
          x.setDni(txtDni.getText());
           x.setCurso(txtCurso.getText());
            x.setNota(txtNota.getText());
            listanotas.add(x);
            refrescarTabla();
